    ...
    <div className="font-sans bg-white pb-32">
      ...
      <section className="relative h-[60vh] flex flex-col justify-center overflow-hidden mb-24">
        <div className="absolute inset-0 z-0 bg-slate-900">
          <img src="https://images.unsplash.com/photo-1488085061387-422e29b40080?auto=format&fit=crop&w=2000&q=85" alt="Real Travel bilan bog'laning" className="w-full h-full object-cover scale-105 animate-[pulse_20s_ease-in-out_infinite] opacity-90" />
